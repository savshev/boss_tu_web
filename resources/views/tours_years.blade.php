...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        let savedIndex = sessionStorage.getItem('active_tour_year_index');
        ...
        function openYearResorts(item, index) {
        ...
        function setActiveItem(index, isInitial = false) {
            ...
            if (originalIndex !== -1) {
                sessionStorage.setItem('active_tour_year_index', originalIndex);
            }
        ...
        document.addEventListener('keydown', function (e) {
            ...
            if (e.key === 'ArrowDown') {
                ...
                e.preventDefault();
                if (visibleItems[currentIndex]) openYearResorts(visibleItems[currentIndex], items.indexOf(visibleItems[currentIndex]));
            }
        });
    });
</script>
