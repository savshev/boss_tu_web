...
<head>
    ...
    <style>
        ...
        /* Контейнер картки з фіксованою висотою */
        ...
        /* Автономний скрол тільки для списку людей */
        ...
        /* Фіксований блок кнопок у самому низу */
    ...
    <div class="people-list" id="peopleList" tabindex="0">
        @forelse($people as $index =>$row)
            ...
            <div class="person-item {{ $index === 0 ? 'active' : '' }}"
                ...
                <div class="col-fam">{{ $fam !== '' ?$fam : 'ПІБ не вказано' }}</div>
            </div>
        @empty
